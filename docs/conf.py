#!/usr/bin/env python
#
# vmdcli documentation build configuration file, created by
...
latex_documents = [
    (master_doc, 'vmdcli.tex',
     'vitemadose-cli Documentation',
