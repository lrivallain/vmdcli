...
vitemadose-cli could always use more documentation, whether as part of the
official vitemadose-cli docs, in docstrings, or even on the web in blog posts,
articles, and such.
...
3. The pull request should work for Python 3.6, 3.7 and 3.8, and for PyPy. Check
   https://travis-ci.org/lrivallain/vmdcli/pull_requests
...
To run a subset of tests::
    ...
    $ python -m unittest tests.test_vmdcli
